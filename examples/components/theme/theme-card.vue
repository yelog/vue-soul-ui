    ...
    <template v-else>
      ...
      <div class="info">
        <div class="info-center">
          ...
          <div v-if="isOfficial" class="description">{{ getActionDisplayName(getDescriptionKey(config.name)) }} </div>
          <div v-else class="description">{{ getActionDisplayName('last-modified') }} {{ formatDate(config.update) }}</div>
        </div>
      </div>
    </template>
  </section>
