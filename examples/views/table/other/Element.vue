...
/* .s-table-element .s-cell > .el-input,
.s-table-element .s-cell > .el-input-number,
.s-table-element .s-cell > .el-select,
.s-table-element .s-cell > .el-cascader,
.s-table-element .s-cell > .el-date-editor {
  width: 100%;
} */
</style>
