    ...
    return h('div', {
      ...
      h('div', {
        ...
        showHeader ? h('div', {
          ...
          h('i', {
            class: ['s-modal--close-btn', 'trigger--btn', GlobalConfig.icon.modalClose],
            on: {
        ...
        h('div', {
          ...
          status ? h('div', {
            ...
            h('i', {
              class: ['s-modal--status-icon', GlobalConfig.icon[`modal${status.replace(/\b(\w)/, word => word.toUpperCase())}`]]
            })
          ]) : null,
          h('div', {
        ...
        showFooter ? h('div', {
          ...
          }, GlobalConfig.i18n('s.button.cancel')) : null,
          h('s-button', {
            props: {
              type: 'primary'
            },
          ...
          }, GlobalConfig.i18n('s.button.confirm'))
        ]) : null,
        !isMsg && resize ? h('span', {
