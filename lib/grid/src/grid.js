...
Object.keys(_table.default.methods).concat(['exportCsv']).forEach(function (name) {
          ...
          case 'query':
            {
              if (ajax.query) {
                ...
                _tools.UtilTools.error('s.error.notQuery');
              }
          ...
          case 'delete':
            {
              if (ajax.delete) {
                  ...
                  if (removeRecords.length) {
                    ...
                    if (isMsg && !selectRecords.length) {
                      _this3.$XModal.message({
                        id: code,
                        message: _conf.default.i18n('soul.grid.selectOneRecord'),
                        status: 'warning'
                      });
                    }
                  }
                ...
                _tools.UtilTools.error('s.error.notDelete');
              }
          ...
          case 'save':
            {
              if (ajax.save) {
                    ...
                    if (vaild) {
                      if (body.insertRecords.length || removeRecords.length || updateRecords.length || body.pendingRecords.length) {
                        ...
                        resolve(ajax.save.apply(_this3, [{
                          ...
                          _this3.$XModal.message({
                            id: code,
                            message: _conf.default.i18n('soul.grid.saveSuccess'),
                            status: 'success'
                          });
                        ...
                        if (isMsg) {
                          ...
                          if (pendingRecords.length) {
                            ...
                            _this3.$XModal.message({
                              id: code,
                              message: _conf.default.i18n('soul.grid.dataUnchanged'),
                              status: 'info'
                            });
                          }
                        }
                ...
                _tools.UtilTools.error('s.error.notSave');
              }
