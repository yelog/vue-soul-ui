          ...
          case 'query':
            {
              if (ajax.query) {
                ...
                _tools.UtilTools.error('vxe.error.notQuery');
              }
          ...
          case 'delete':
            {
              if (ajax.delete) {
                ...
                _tools.UtilTools.error('vxe.error.notDelete');
              }
          ...
          case 'save':
            {
              if (ajax.save) {
                ...
                _tools.UtilTools.error('vxe.error.notSave');
              }
    ...
    handleDeleteRow: function handleDeleteRow(code, alertKey, callback) {
      ...
      if (this.isMsg) {
        if (selectRecords.length) {
          this.$XMsg.confirm(_conf.default.i18n(alertKey)).then(function (type) {
            if (type === 'confirm') {
              callback();
            }
          });
