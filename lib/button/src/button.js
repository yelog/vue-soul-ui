...
var _default = {
  ...
  render: function render(h) {
    ...
    return $scopedSlots.dropdowns ? h('div', {
      ...
      class: "s-button--dropdown-arrow ".concat(_conf.default.icon.dropdownBottom)
    })]), h('div', {
  ...
  methods: {
    renderContent: function renderContent(h) {
      ...
      if (loading) {
        contents.push(h('i', {
          class: ['s-button--loading-icon', _conf.default.icon.btnLoading]
        }));
      } else if (icon) {
        contents.push(h('i', {
    ...
    clickDropdownEvent: function clickDropdownEvent(evnt) {
      ...
      var _DomTools$getEventTar = _tools.DomTools.getEventTargetNode(evnt, dropdownElem, 's-button'),
