...
var _default2 = {
  ...
  render: function render(h) {
    ...
    return h('div', {
      ...
      class: 's-msg--title'
    }, title ? _tools.UtilTools.getFuncText(title) : _conf.default.i18n('soul.alert.title')), h('i', {
      class: ['s-msg--close-btn', _conf.default.icon.msgClose],
      on: {
      ...
      class: ['s-msg--status-icon', _conf.default.icon["msg".concat(status.replace(/\b(\w)/, function (word) {
    ...
    }, _conf.default.i18n('soul.button.cancel')) : null, h('s-button', {
      props: {
        type: 'primary'
      },
      on: {
    ...
    }, _conf.default.i18n('soul.button.confirm'))]) : null])]);
  },
  methods: {
    ...
    updateStyle: function updateStyle() {
      this.$nextTick(function () {
        ...
        _msgQueue.default.forEach(function (comp) {
          offsetTop += comp.top;
