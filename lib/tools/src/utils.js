...
function () {
  ...
  _createClass(ColumnConfig, [{
    ...
    value: function getTitle() {
      // 在 v3.0 中废弃 label
      return UtilTools.getFuncText(this.own.title || this.own.label || (this.type === 'index' ? _conf.default.i18n('s.column.indexTitle') : ''));
    }
  }, {
    key: "update",
...
var UtilTools = {
  ...
  getLog: function getLog(message, params) {
    return "[s-table] ".concat(_xeUtils.default.template(_conf.default.i18n(message), params));
  },
