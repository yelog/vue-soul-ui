...
function renderRows(h, _vm, $table, $seq, rowLevel, fixedType, tableData, tableColumn) {
  ...
  tableData.forEach(function (row, $rowIndex) {
    ...
    rows.push(h('tr', {
      class: ['s-body--row', (_ref3 = {}, _defineProperty(_ref3, "row--level-".concat(rowLevel), treeConfig), _defineProperty(_ref3, 'row--new', editStore.insertList.indexOf(row) > -1), _ref3), rowClassName ? _xeUtils.default.isFunction(rowClassName) ? rowClassName({
        $table: $table,
        $seq: $seq,
        seq: seq,
        fixedType: fixedType,
...
var _default = {
  ...
  render: function render(h) {
    ...
    }, $table.$slots.empty || _conf.default.i18n('soul.table.emptyText'))]) : null]);
  },
  methods: {
    /**
     * 滚动处理
