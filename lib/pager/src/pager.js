...
var _default2 = {
  ...
  methods: {
    ...
    renderSizes: function renderSizes(h) {
      ...
      return h('span', {
      ...
      }, [h('span', "".concat(pageSize).concat(_conf.default.i18n('soul.pager.pagesize'))), h('i', {
        ...
        }, "".concat(num).concat(_conf.default.i18n('soul.pager.pagesize')));
      }))])]);
    },
    // FullJump
    ...
    renderJump: function renderJump(h, isFull) {
      ...
      }, _conf.default.i18n('soul.pager.goto')) : null, h('input', {
        class: 's-pager--goto',
        domProps: {
          value: currentPage
        },
      ...
      }, _conf.default.i18n('soul.pager.pageClassifier')) : null]);
    },
    // PageCount
    ...
    renderTotal: function renderTotal(h) {
      ...
      return h('span', {
        class: 's-pager--total'
      }, _xeUtils.default.template(_conf.default.i18n('soul.pager.total'), {
        total: total
      }));
    },
    // number
