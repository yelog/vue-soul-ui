  ...
  methods: {
    ...
    renderPrevPage: function renderPrevPage(h) {
      ...
      return h('span', {
        ...
        class: ['s-icon--page-icon', _conf.default.icon.prevPage]
      })]);
    },
    // 向上翻页
    renderPrevJump: function renderPrevJump(h, tagName) {
      return h(tagName || 'span', {
        ...
        class: ['s-pager--jump-icon', _conf.default.icon.jumpPrev]
      })]);
    },
    // number
    ...
    renderNextJump: function renderNextJump(h, tagName) {
      ...
      return h(tagName || 'span', {
        ...
        class: ['s-pager--jump-icon', _conf.default.icon.jumpNext]
      })]);
    },
    // 下一页
    renderNextPage: function renderNextPage(h) {
      ...
      return h('span', {
        ...
        class: ['s-icon--page-icon', _conf.default.icon.nextPage]
      })]);
    },
    // sizes
    renderSizes: function renderSizes(h) {
      ...
      return h('span', {
      ...
      }, [h('span', "".concat(pageSize).concat(_conf.default.i18n('s.pager.pagesize'))), h('i', {
        class: "s-pager--sizes-arrow ".concat(_conf.default.icon.caretBottom)
      })]), h('div', {
        ...
        }, "".concat(num).concat(_conf.default.i18n('s.pager.pagesize')));
      }))])]);
    },
    // FullJump
    ...
    renderJump: function renderJump(h, isFull) {
      ...
      }, _conf.default.i18n('s.pager.goto')) : null, h('input', {
        class: 's-pager--goto',
        domProps: {
          value: currentPage
        },
      ...
      }, _conf.default.i18n('s.pager.pageClassifier')) : null]);
    },
    // PageCount
    ...
    renderTotal: function renderTotal(h) {
      ...
      return h('span', {
        class: 's-pager--total'
      }, _xeUtils.default.template(_conf.default.i18n('s.pager.total'), {
        total: total
      }));
    },
    // number
