...
/* harmony default export */ var table = ({
  ...
  methods: {
                ...
                if (layout === 'header') {
                  ...
                  if (_listElem2 && _hasEllipsis) {
                    external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.arrayEach(_listElem2.querySelectorAll(".".concat(column.id)), function (tdElem) {
                      var cellElem = tdElem.querySelector('.s-cell');
    ...
    handleGlobalMousedownEvent: function handleGlobalMousedownEvent(evnt) {
      ...
      if (filterWrapper) {
        if (this.getEventTargetNode(evnt, this.$el, 's-filter-wrapper').flag) {// 如果点击了筛选按钮
          ...
          if (validTip && this.getEventTargetNode(evnt, validTip.$el).flag) {// 如果是激活状态，且点击了校验提示框
            ...
            this.preventEvent(evnt, 'event.clear_actived', actived.args, function () {
              ...
              if (editConfig.mode === 'row') {
                var rowNode = _this12.getEventTargetNode(evnt, _this12.$el, 's-body--row');
  ...
  render: function render(h) {
    ...
    h('tfoot', {
      ...
      return h('tr', {
        ...
        return h('td', {
          class: ['s-footer--column', column.id, (_ref = {}, _defineProperty(_ref, "col--".concat(column.headerAlign), column.headerAlign), _defineProperty(_ref, 'fixed--hidden', fixedHiddenColumn), _defineProperty(_ref, 'filter--active', column.filters.some(function (item) {
            return item.checked;
...
/* harmony default export */ var src_message = ({
  ...
  render: function render(h) {
    ...
    }, conf.i18n('vxe.button.cancel')) : null, h('s-button', {
      props: {
        type: 'primary'
      },
      on: {
