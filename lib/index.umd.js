...
function outLog(type) {
  return function (message) {
    var msg = "[s-table] ".concat(conf.i18n(message));
    console[type](msg);
    return msg;
  };
}
...
var DomTools = {
  ...
  getCell: function getCell($table, _ref) {
    ...
    return $table.$refs.tableBody.$el.querySelector(".s-body--row[data-rowid=\"".concat(rowid, "\"] .").concat(column.id));
  },
...
var Cell = {
  ...
  renderSelectionHeader: function renderSelectionHeader(h, params) {
    ...
    return [h('label', {
      class: ['s-checkbox', (_ref2 = {}, _defineProperty(_ref2, "size--".concat(vSize), vSize), _defineProperty(_ref2, 'is--indeterminate', $table.isIndeterminate), _ref2)]
    }, [h('input', options), h('span', {
...
var Methods = {
  ...
  loadTableData: function loadTableData(datas, notRefresh) {
    ...
    if (scrollYLoad && !(height || maxHeight)) {
      UtilTools.error('s.error.scrollYHeight');
    }
    ...
    return rest.then(function () {
      if (_this3.scrollXLoad || _this3.scrollYLoad) {
        if (_this3.mouseConfig) {
          UtilTools.error('s.error.notMouse');
        }
      }
  ...
  insertAt: function insertAt(records, row) {
    ...
    if (treeConfig) {
      throw new Error(UtilTools.error('s.error.treeInsert'));
    }
  ...
  revert: function revert() {
    UtilTools.warn('s.error.delRevert');
  ...
  getRecords: function getRecords() {
    UtilTools.warn('s.error.delGetRecords');
  ...
  getAllRecords: function getAllRecords() {
    UtilTools.warn('s.error.delGetAllRecords');
  ...
  refreshColumn: function refreshColumn() {
    ...
    if (scrollXLoad) {
      if (this.resizable || visibleColumn.some(function (column) {
        ...
        UtilTools.warn('s.error.notResizable');
      }
...
/* harmony default export */ var table = ({
  ...
  created: function created() {
    ...
    if (!table_core._keyboard && (this.keyboardConfig || this.mouseConfig)) {
      throw new Error(UtilTools.error('s.error.reqKeyboard'));
    }

    if (!table_core._resize && this.autoResize) {
...
function renderRows(h, _vm, $table, $seq, rowLevel, fixedType, tableData, tableColumn) {
  ...
  tableData.forEach(function (row, $rowIndex) {
    ...
    rows.push(h('tr', {
      class: ['s-body--row', (_ref3 = {}, _defineProperty(_ref3, "row--level-".concat(rowLevel), treeConfig), _defineProperty(_ref3, 'row--new', editStore.insertList.indexOf(row) > -1), _ref3), rowClassName ? xe_utils_amd_xe_utils_default.a.isFunction(rowClassName) ? rowClassName({
        $table: $table,
        $seq: $seq,
        seq: seq,
        fixedType: fixedType,
  ...
  triggerFilterEvent: function triggerFilterEvent(evnt, column, params) {
    ...
    if (filterStore.column === column && filterStore.visible) {
      ...
      if (DomTools.getParents($el, '.s-table-complete-outline').length > 0) {
        var _DomTools$getOffsetPo = DomTools.getOffsetPos(targetElem, DomTools.getParents($el, '.s-table-complete-outline')[0].children[0]),
            otop = _DomTools$getOffsetPo.top,
            oleft = _DomTools$getOffsetPo.left;
...
/* harmony default export */ var pager = ({
  ...
  render: function render(h) {
    ...
    return h('div', {
      class: ['s-pager', (_ref = {}, _defineProperty(_ref, "size--".concat(vSize), vSize), _defineProperty(_ref, "align--".concat(align), align), _defineProperty(_ref, 'p--background', background), _defineProperty(_ref, 'is--loading', loading), _ref)]
...
/* harmony default export */ var modal = ({
  ...
  render: function render(h) {
    ...
    return h('div', {
      ...
      $modal: this
    }, h) : _xe_utils_2_2_4_xe_utils_default.a.isFunction(message) ? message.call(this, h) : message)]), showFooter ? h('div', {
  ...
  methods: {
    ...
    open: function open() {
      ...
      if (!visible) {
        ...
        if (isMsg) {
          this.addMsgQueue();
          setTimeout(this.close, _xe_utils_2_2_4_xe_utils_default.a.toNumber(duration));
        } else {
          this.$nextTick(function () {
    ...
    removeMsgQueue: function removeMsgQueue() {
      ...
      if (src_queue.indexOf(this) > -1) {
        _xe_utils_2_2_4_xe_utils_default.a.remove(src_queue, function (comp) {
          return comp === _this3;
        });
      }
    ...
    updateStyle: function updateStyle() {
      this.$nextTick(function () {
        ...
        src_queue.forEach(function (comp) {
          offsetTop += _xe_utils_2_2_4_xe_utils_default.a.toNumber(comp.top);
...
['alert', 'confirm', 'message'].forEach(function (type, index) {
  ...
  Modal[type] = function (message, title, options) {
    ...
    if (_xe_utils_2_2_4_xe_utils_default.a.isObject(message)) {
      opts = message;
    } else {
      if (title) {
        opts = {
    ...
    return Modal(Object.assign({
      message: _xe_utils_2_2_4_xe_utils_default.a.toString(message),
      type: type
...
function getCsvLabelData(columns, oData, tableElem) {
  var trElemList = tableElem.querySelectorAll('.s-table--body-wrapper.body--wrapper .s-body--row');
    ...
    if (isLeftBtn && mouseConfig.checked) {
      ...
      if (isIndex) {
        ...
        var updateEvent = xe_utils_amd_xe_utils_default.a.throttle(function (evnt) {
          ...
          var _DomTools$getEventTar = DomTools.getEventTargetNode(evnt, $el, 's-header--column'),
              flag = _DomTools$getEventTar.flag,
              targetElem = _DomTools$getEventTar.targetElem;

          if (!flag) {
            var a = DomTools.getEventTargetNode(evnt, $el, 's-body--column');
            flag = a.flag;
      ...
      if (actived.row !== row || !(editConfig.mode === 'cell' && actived.column === column)) {
        if (isLeftBtn && mouseConfig.checked) {
          ...
          var updateEvent = xe_utils_amd_xe_utils_default.a.throttle(function (evnt) {
            ...
            var _DomTools$getEventTar2 = DomTools.getEventTargetNode(evnt, $el, 's-body--column'),
