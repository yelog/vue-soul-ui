  ...
  methods: {
        ...
        return Promise.all(rowValids).then(function () {
          ...
          return new Promise(function (resolve, reject) {
            var finish = function finish() {
              params.cell = DomTools.getCell(_this36, params);
    ...
    showValidTooltip: function showValidTooltip(params) {
      ...
      this.$nextTick(function () {
        ...
        UtilTools.emitEvent(_this39, 'valid-error', [params]);
      });
    },
...
/* harmony default export */ var src_button = ({
  ...
  render: function render(h) {
    ...
    return $scopedSlots.dropdowns ? h('div', {
      ...
      class: "s-button--dropdown-arrow ".concat(conf.icon.caretBottom)
    })]), h('div', {
  ...
  methods: {
    clickDropdownEvent: function clickDropdownEvent(evnt) {
      ...
      if (DomTools.getEventTargetNode(evnt, dropdownElem, 's-button').flag) {
