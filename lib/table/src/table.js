  ...
  methods: {
    ...
    triggerFilterEvent: function triggerFilterEvent(evnt, column, params) {
      ...
      if (filterStore.column === column && filterStore.visible) {
        ...
        if (_tools.DomTools.getParents($el, '.s-table-complete-outline').length > 0) {
          var _DomTools$getOffsetPo2 = _tools.DomTools.getOffsetPos(targetElem, _tools.DomTools.getParents($el, '.s-table-complete-outline')[0].children[0]),
