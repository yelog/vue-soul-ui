...
var _default2 = {
  ...
  methods: {
    ...
    updateAfterFullData: function updateAfterFullData() {
      ...
      tableData = tableData.filter(function (row) {
        return filterColumn.every(function (column) {
          ...
          var compConf = filterRender ? _sTable.Renderer.get(filterRender.name) : null;
          var valueList = [];
          var itemList = [];
    ...
    preventEvent: function preventEvent(evnt, type, args, callback) {
      ...
      var evntList = _sTable.Interceptor.get(type);
    ...
    handleFocus: function handleFocus(params, evnt) {
      ...
      if (editRender) {
        var compRender = _sTable.Renderer.get(editRender.name);
