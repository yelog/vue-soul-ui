...
/* harmony default export */ var src_body = ({
  ...
  render: function render(h) {
    ...
    !fixedType && (mouseConfig.checked || keyboardConfig.isCut) ? h('div', {
      ...
      $table: $table
    }, h) : conf.i18n('soul.table.emptyText'))]) : null]);
  },
  methods: {
    /**
     * 滚动处理
  ...
  methods: {
    renderOptions: function renderOptions(h) {
      ...
      var filterRens = [h('li', {
        ...
        class: 's-checkbox--label'
      }, conf.i18n('soul.table.allFilter'))]) : h('span', {
        class: 's-table--filter-label',
        on: {
          click: $table.resetFilterEvent
        }
      }, conf.i18n('soul.table.allFilter'))])];
    ...
    renderFooter: function renderFooter(h) {
      ...
      }, conf.i18n('soul.table.confirmFilter')), h('button', {
        on: {
          click: this.resetFilter
        }
      }, conf.i18n('soul.table.resetFilter'))]) : null;
    },
    // 全部筛选事件
                  ...
                  if (removeRecords.length) {
                    ...
                    if (isMsg && !selectRecords.length) {
                      _this3.$XModal.message({
                        id: code,
                        message: conf.i18n('soul.grid.selectOneRecord'),
                        status: 'warning'
                      });
                    }
                  }
                    ...
                    if (vaild) {
                      if (body.insertRecords.length || removeRecords.length || updateRecords.length || body.pendingRecords.length) {
                        ...
                        resolve(ajax.save.apply(_this3, [{
                          ...
                          _this3.$XModal.message({
                            id: code,
                            message: conf.i18n('soul.grid.saveSuccess'),
                            status: 'success'
                          });
                        ...
                        if (isMsg) {
                          ...
                          if (pendingRecords.length) {
                            ...
                            _this3.$XModal.message({
                              id: code,
                              message: conf.i18n('soul.grid.dataUnchanged'),
                              status: 'info'
                            });
                          }
                        }
...
/* harmony default export */ var pager = ({
  ...
  methods: {
    ...
    renderSizes: function renderSizes(h) {
      ...
      return h('span', {
      ...
      }, [h('span', "".concat(pageSize).concat(conf.i18n('soul.pager.pagesize'))), h('i', {
        ...
        }, "".concat(num).concat(conf.i18n('soul.pager.pagesize')));
      }))])]);
    },
    // FullJump
    ...
    renderJump: function renderJump(h, isFull) {
      ...
      }, conf.i18n('soul.pager.goto')) : null, h('input', {
        class: 's-pager--goto',
        domProps: {
          value: currentPage
        },
      ...
      }, conf.i18n('soul.pager.pageClassifier')) : null]);
    },
    // PageCount
    ...
    renderTotal: function renderTotal(h) {
      ...
      return h('span', {
        class: 's-pager--total'
      }, xe_utils_amd_xe_utils_default.a.template(conf.i18n('soul.pager.total'), {
        total: total
      }));
    },
    // number
