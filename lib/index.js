(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["STable"] = factory(require("xe-utils"));
	else
...
var Cell = {
  ...
  renderEditHeader: function renderEditHeader(h, params) {
    ...
    })].concat(sortable || remoteSort ? Cell.renderSortIcon(h, params) : []).concat(filters && filters.length ? Cell.renderFilterIcon(h, params) : []).concat(Cell.renderHeader(h, params));
  },
  // 行格编辑模式
...
/* harmony default export */ var table = ({
  ...
  methods: {
    ...
    insertAt: function insertAt(records, row) {
      ...
      if (!row) {
        ...
        if (row === -1) {
          ...
          if (targetIndex === -1) {
            throw new Error('[s-table] Unable to insert to the specified location.');
          }
    ...
    clearHoverRow: function clearHoverRow() {
      external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.arrayEach(this.$el.querySelectorAll('.s-body--row.row--hover'), function (elem) {
          ...
          if (column && column.editRender) {
            ...
            if (cell) {
              _this27.handleActived({
                row: row,
                rowIndex: _this27.getRowIndex(row),
                column: column,
                columnIndex: _this27.getColumnIndex(column),
                cell: cell,
                $table: _this27
              });
    ...
    triggerFilterEvent: function triggerFilterEvent(evnt, column, params) {
      ...
      if (filterStore.column === column && filterStore.visible) {
        ...
        if (DomTools.getParents($el, '.s-table-complete-outline').length > 0) {
          var _DomTools$getOffsetPo2 = DomTools.getOffsetPos(targetElem, DomTools.getParents($el, '.s-table-complete-outline')[0].children[0]),
              otop = _DomTools$getOffsetPo2.top,
              oleft = _DomTools$getOffsetPo2.left;
...
/* harmony default export */ var header = ({
  ...
  render: function render(h) {
    ...
    h('thead', {
      ...
      return h('tr', {
        class: ['s-header--row', headerRowClassName ? external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.isFunction(headerRowClassName) ? headerRowClassName({
          $table: $table,
          $rowIndex: $rowIndex,
          fixed: fixedType
        }) : headerRowClassName : '']
...
function renderRows(h, _vm, $table, $seq, rowLevel, fixedType, tableData, tableColumn) {
  ...
  tableData.forEach(function (row, $rowIndex) {
    ...
    rows.push(h('tr', {
      class: ['s-body--row', (_ref3 = {}, _defineProperty(_ref3, "row--level-".concat(rowLevel), treeConfig), _defineProperty(_ref3, 'row--new', editStore.insertList.indexOf(row) > -1), _ref3), rowClassName ? external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.isFunction(rowClassName) ? rowClassName({
        $table: $table,
        $seq: $seq,
        seq: seq,
        fixedType: fixedType,
...
/* harmony default export */ var src_body = ({
  ...
  render: function render(h) {
    ...
    }, $table.$slots.empty || conf.i18n('soul.table.emptyText'))]) : null]);
  },
  methods: {
    /**
     * 滚动处理
...
/* harmony default export */ var footer = ({
  ...
  render: function render(h) {
    ...
    h('tfoot', {
      ...
      return h('tr', {
        class: ['s-footer--row', footerRowClassName ? external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.isFunction(footerRowClassName) ? footerRowClassName({
          $table: $table,
          $rowIndex: $rowIndex,
          fixed: fixedType
        }) : footerRowClassName : '']
        ...
        return h('td', {
          class: ['s-footer--column', column.id, (_ref = {}, _defineProperty(_ref, "col--".concat(column.headerAlign), column.headerAlign), _defineProperty(_ref, 'fixed--hidden', fixedHiddenColumn), _defineProperty(_ref, 'col--ellipsis', hasEllipsis), _defineProperty(_ref, 'filter--active', column.filters.some(function (item) {
            return item.checked;
...
/* harmony default export */ var pager = ({
  ...
  methods: {
    ...
    renderTotal: function renderTotal(h) {
      ...
      return h('span', {
        class: 's-pager--total'
      }, external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.template(conf.i18n('soul.pager.total'), {
        total: total
      }));
    },
    // number
...
/* harmony default export */ var create = (function (compName) {
  ...
  return {
    name: external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.camelCase("S-".concat(compName)),
    props: {
      value: [String, Number],
      name: String,
      type: {
...
/* harmony default export */ var src_message = ({
  ...
  render: function render(h) {
    ...
    var vSize = this.vSize,
        ...
        isMsg = this.isMsg;
    return h('div', {
      class: ['s-msg--wrapper', "type--".concat(type), (_ref = {}, _defineProperty(_ref, "size--".concat(vSize), vSize), _defineProperty(_ref, "msg--".concat(status), status), _defineProperty(_ref, 'is--animat', animat), _defineProperty(_ref, 'lock--view', lockView), _defineProperty(_ref, 'is--mask', mask), _defineProperty(_ref, 'is--visible', contentVisible), _defineProperty(_ref, "active", visible), _ref)],
      style: {
        zIndex: zIndex,
      ...
      class: 's-msg--title'
    }, title ? UtilTools.getFuncText(title) : conf.i18n('soul.alert.title')), h('i', {
      class: ['s-msg--close-btn', conf.icon.msgClose],
      on: {
      ...
      class: ['s-msg--status-icon', conf.icon["msg".concat(status.replace(/\b(\w)/, function (word) {
    ...
    }, conf.i18n('soul.button.cancel')) : null, h('s-button', {
      props: {
        type: 'primary'
      },
      on: {
    ...
    }, conf.i18n('soul.button.confirm'))]) : null])]);
  },
  methods: {
...
/* harmony default export */ var index_0 = (table_core);
