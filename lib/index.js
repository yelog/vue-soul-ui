...
// CONCATENATED MODULE: ./packages/table-core/src/use.js
...
var utils_ColumnConfig = function ColumnConfig(_vm) {
  ...
  if (_vm.cellRender && _vm.editRender) {
    console.warn('[s-table] Properties cell-render and edit-render cannot be used together.');
  }
...
var Cell = {
  ...
  renderRadioCell: function renderRadioCell(h, params) {
    ...
    return [h('label', {
      class: ['s-radio', _defineProperty({}, "size--".concat(vSize), vSize)]
          ...
          if (validTip && this.getEventTargetNode(evnt, validTip.$el).flag) {// 如果是激活状态，且点击了校验提示框
            ...
            this.preventEvent(evnt, 'event.clear_actived', actived.args, function () {
              ...
              if (editConfig.mode === 'row') {
                var rowNode = _this17.getEventTargetNode(evnt, $el, 's-body--row');
...
function excel_ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { keys.push.apply(keys, Object.getOwnPropertySymbols(object)); } if (enumerableOnly) keys = keys.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; }); return keys; }

function excel_objectSpread(target) { for (var i = 1; i < arguments.length; i++) { if (i % 2) { var source = arguments[i] != null ? arguments[i] : {}; excel_ownKeys(source, true).forEach(function (key) { _defineProperty(target, key, source[key]); }); } else if (Object.getOwnPropertyDescriptors) { Object.defineProperties(target, Object.getOwnPropertyDescriptors(arguments[i])); } else { excel_ownKeys(source).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(arguments[i], key)); }); } } return target; }
...
/* harmony default export */ var excel = ({
  ...
  computed: {
    tableProps: function tableProps() {
      var $props = this.$props,
          editConfig = this.editConfig;
      return excel_objectSpread({}, $props, {
        border: true,
        resizable: true,
        showOverflow: null,
  ...
  render: function render(h) {
    ...
    return h('s-table', {
      class: 's-excel',
      props: tableProps,
      on: excel_objectSpread({}, $listeners, {
...
excel.install = function (Vue) {
  table_core.renderer.mixin(cells);
...
/* harmony default export */ var src_toolbar = ({
  ...
  render: function render(h) {
    ...
    return h('div', {
      class: ['s-toolbar', _defineProperty({}, "size--".concat(vSize), vSize)]
    }, [h('div', {
...
/* harmony default export */ var pager = ({
  ...
  render: function render(h) {
    ...
    return h('div', {
      class: ['s-pager', (_ref = {}, _defineProperty(_ref, "size--".concat(vSize), vSize), _defineProperty(_ref, 'p--background', background), _defineProperty(_ref, 'is--loading', loading), _ref)]
...
/* harmony default export */ var input = ({
  ...
  render: function render(h) {
    ...
    var $listeners = this.$listeners,
        ...
        disabled = this.disabled;
    return h('div', {
      class: ['s-input--wrapper', (_ref = {}, _defineProperty(_ref, "size--".concat(vSize), vSize), _defineProperty(_ref, 'is--disabled', this.disabled), _ref)]
    }, [h('input', {
      class: "s-input",
      domProps: {
        value: value
...
/* harmony default export */ var src_button = ({
  ...
  render: function render(h) {
    ...
    return h('button', {
      class: ['s-button', "type--".concat(isText ? type : 'button'), (_ref = {}, _defineProperty(_ref, "size--".concat(vSize), vSize), _defineProperty(_ref, "theme--".concat(type), type && !isText), _ref)],
      attrs: {
        disabled: disabled
      },
      on: external_root_XEUtils_commonjs_xe_utils_commonjs2_xe_utils_amd_xe_utils_default.a.objectMap($listeners, function (cb, type) {
...
/* harmony default export */ var src_message = ({
  ...
  render: function render(h) {
    ...
    return h('div', {
      ...
      class: 's-msg--title'
    }, title || conf.i18n('soul.alert.title')), h('i', {
