...
var helperFixedNumber = __webpack_require__("357a")
...
var browse = xe_utils_default.a.browse();
...
var DomTools = {
  ...
  getCellNodeIndex: function getCellNodeIndex(cell) {
    ...
    var columnIndex = xe_utils_default.a.arrayIndexOf(trElem.children, cell);
    var rowIndex = xe_utils_default.a.arrayIndexOf(trElem.parentNode.children, trElem);
    return {
...
/* harmony default export */ var table = ({
  ...
  render: function render(h) {
    ...
    !loading && !tableData.length ? h('div', {
      ...
      $table: this
    }, h) : conf.i18n('s.table.emptyText'))]) : _e(),
    /**
     * 列宽线
     */
    isResizable ? h('div', {
...
fileForm.className = 's-table--import-form';
fileInput.name = 'file';
fileInput.type = 'file';
