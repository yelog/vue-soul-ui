...
var _default = {
  ...
  render: function render(h) {
    ...
    return h('s-modal', {
      ...
      props: {
        title: _conf.default.i18n('s.toolbar.expTitle'),
        width: 660,
        mask: true,
        lockView: true,
        showFooter: false,
    ...
    }, [h('tr', [h('td', _conf.default.i18n('s.toolbar.expName')), h('td', [h('input', {
      ref: 'filename',
      attrs: {
        type: 'text',
        placeholder: _conf.default.i18n('s.toolbar.expNamePlaceholder')
      },
      domProps: {
    ...
    })])]), h('tr', [h('td', _conf.default.i18n('s.toolbar.expType')), h('td', [h('select', {
      on: {
    ...
    }))])]), showSheet ? h('tr', [h('td', _conf.default.i18n('s.toolbar.expSheetName')), h('td', [h('input', {
      attrs: {
        type: 'text',
        placeholder: _conf.default.i18n('s.toolbar.expSheetNamePlaceholder')
      },
      domProps: {
    ...
    })])]) : _e(), h('tr', [h('td', _conf.default.i18n('s.toolbar.expMode')), h('td', [h('select', {
      on: {
        change: function change(evnt) {
    ...
    }))])]), h('tr', [h('td', [_conf.default.i18n('s.toolbar.expColumn')]), h('td', [h('div', {
    ...
    }, _conf.default.i18n('s.toolbar.expAllColumn')), h('ul', storeData.columns.map(function (column) {
      var own = column.own,
      ...
      }, _tools.UtilTools.getFuncText(own.title || own.label || (type === 'index' ? _conf.default.i18n('s.column.indexTitle') : '')));
    }))])])]), h('tr', [h('td', _conf.default.i18n('s.toolbar.expOpts')), h('td', [h('s-checkbox', {
      model: {
    ...
    }, _conf.default.i18n('s.toolbar.expOptHeader')), h('s-checkbox', {
      props: {
    ...
    }, _conf.default.i18n('s.toolbar.expOptFooter')), h('s-checkbox', {
      props: {
    ...
    }, _conf.default.i18n('s.toolbar.expOptOriginal'))])])]), h('div', {
      class: 's-export--panel-btns'
    }, [h('s-button', {
      on: {
        click: this.printEvent
      }
    }, _conf.default.i18n('s.toolbar.expPrint')), h('s-button', {
      props: {
        type: 'primary'
      },
      on: {
    ...
    }, _conf.default.i18n('s.toolbar.expConfirm'))])])]);
  },
  methods: {
