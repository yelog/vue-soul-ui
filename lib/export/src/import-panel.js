...
var _default = {
  ...
  computed: {
    ...
    parseTypeLabel: function parseTypeLabel() {
      ...
      if (storeData.type) {
        return _conf.default.i18n("s.types.".concat(storeData.type));
      }

      return "*.".concat((this.defaultOptions.types || _tableCore.default.importTypes).join(', *.'));
    }
  },
  render: function render(h) {
    ...
    return h('s-modal', {
      ...
      props: {
        title: _conf.default.i18n('s.toolbar.impTitle'),
        width: 440,
        mask: true,
        lockView: true,
        showFooter: false,
    ...
    }, [h('tr', [h('td', _conf.default.i18n('s.toolbar.impFile')), h('td', [hasFile ? h('div', {
    ...
    }, _conf.default.i18n('s.toolbar.impSelect'))])]), h('tr', [h('td', _conf.default.i18n('s.toolbar.impType')), h('td', parseTypeLabel)]), h('tr', [h('td', _conf.default.i18n('s.toolbar.impOpts')), h('td', [h('s-radio', {
      props: {
        name: 'mode',
        label: 'covering'
      },
    ...
    }, _conf.default.i18n('s.toolbar.impModeCovering')), h('s-radio', {
      props: {
        name: 'mode',
        label: 'append'
      },
    ...
    }, _conf.default.i18n('s.toolbar.impModeAppend'))])])]), h('div', {
    ...
    }, _conf.default.i18n('s.toolbar.impConfirm'))])])]);
  },
  methods: {
