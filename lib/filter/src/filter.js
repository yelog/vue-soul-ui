...
var _default = {
  ...
  methods: {
    renderOptions: function renderOptions(h) {
      ...
      }, _conf.default.i18n('soul.table.allFilter'))]) : h('span', {
        class: 's-table--filter-label',
        on: {
          click: $table.resetFilterEvent
        }
      }, _conf.default.i18n('soul.table.allFilter'))])];
    ...
    renderFooter: function renderFooter(h) {
      ...
      }, _conf.default.i18n('soul.table.confirmFilter')), h('button', {
        on: {
          click: this.resetFilter
        }
      }, _conf.default.i18n('soul.table.resetFilter'))]) : null;
    },
    // 全部筛选事件
