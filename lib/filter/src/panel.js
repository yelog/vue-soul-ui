...
var _default = {
  ...
  methods: {
    renderOptions: function renderOptions(h) {
      ...
      }, _conf.default.i18n('s.table.allFilter'))]) : h('span', {
        class: 's-table--filter-label',
        on: {
          click: $table.resetFilterEvent
        }
      }, _conf.default.i18n('s.table.allFilter'))])];
    ...
    renderFooter: function renderFooter(h) {
      ...
      }, _conf.default.i18n('s.table.confirmFilter')), h('button', {
        on: {
          click: this.resetFilter
        }
      }, _conf.default.i18n('s.table.resetFilter'))]) : null;
    },
    // 全部筛选事件
